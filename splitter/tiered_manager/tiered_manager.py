...
from splitter.tiered_manager.tiered import *
from splitter.tiered_manager.tiered_videoio import *
from splitter.tiered_manager.tiered_file import *

from splitter.constants import *
from splitter.struct import *
from splitter.dataflow.map import Sample
from splitter.header import *
...
class TieredStorageManager(StorageManager):
    ...
    def size(self, name):
        """ Return the total amount of space a splitter video takes up
        (including headers)
        """
        seq = 0
        size = 0
